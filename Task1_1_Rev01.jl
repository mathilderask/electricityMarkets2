...
for i in 1:no_of_scenarios
    ...
    pricing_scheme_local = "two-price"              # Select "one-price" or "two-price"
    opt_production, expected_profit = optimise_bidding_quantity(p_real_local, lambda_DA_local, system_status_local, pricing_scheme_local)
